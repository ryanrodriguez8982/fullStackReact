...
import { Breadcrumb, BreadcrumbItem, Button, Form, FormGroup, Label, Input, Col, Row, Feedback, FormFeedback } from 'reactstrap';
            ...
            <Form onSubmit={this.handleSubmit}>
              ...
              <FormGroup row>
                ...
                <Col md={{ size: 3, offset: 1 }}>
                  <Input type="select" name="contatctType" value={this.state.contactType} onChange={this.handleInputChange} >
                    <option>Tel.</option>
                    <option>Email</option>
                  </Input>
                </Col>
